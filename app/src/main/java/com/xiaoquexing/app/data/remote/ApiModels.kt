...
@Serializable
data class SyncPushReq(
    val batchId: String,
    val mutations: List<SyncMutation> = emptyList(),
)
...
data class SyncMutation(
    ...
    val entityType: String = "RECORD",
    val operation: String,
    val clientLocalId: Long = 0,
    val serverId: String? = null,
    val baseVersion: Long = 0,
    val occurredAt: String? = null,
    val occurredDate: String? = null,
    val timezone: String = "Asia/Shanghai",
    val payload: RecordWrite? = null,
)

@Serializable
data class SyncPushRes(
    val results: List<MutationResult> = emptyList(),
)

@Serializable
data class SyncPullRes(
